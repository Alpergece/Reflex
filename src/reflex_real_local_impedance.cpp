...
{   
    ...
    right_command = nh.advertise<trajectory_msgs::JointTrajectory>("/iRosa_arm_right_controller/command", 1);
    left_command = nh.advertise<trajectory_msgs::JointTrajectory>("/iRosa_arm_left_controller/command", 1);
